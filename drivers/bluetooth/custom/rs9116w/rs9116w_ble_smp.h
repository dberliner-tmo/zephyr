...
#ifndef RS9116W_BLE_SMP_H_
#define RS9116W_BLE_SMP_H_ 1
...
void bt_smp_update_keys(struct bt_conn *conn); //IDK
...
// int bt_smp_le_oob_set_tk(struct bt_conn *conn, const uint8_t *tk); //Don't think these are needed
